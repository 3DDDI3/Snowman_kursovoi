...
--
-- Host: localhost    Database: user_21
-- ------------------------------------------------------
...
CREATE TABLE `areas` (
  ...
  `Area` varchar(45) NOT NULL COMMENT 'Наименование области',
  PRIMARY KEY (`idArea`)
...
INSERT INTO `areas` VALUES (1,'Ленинградская');
...
INSERT INTO `contracts` VALUES (1,1,3,2,'2018-10-10',NULL,NULL,1);
...
CREATE TABLE `district` (
  ...
  `district` varchar(45) NOT NULL COMMENT 'Район',
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `owners` (
  `idOwner` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id Владельца',
  `surname` varchar(45) NOT NULL COMMENT 'Фамилия',
  `name` varchar(45) NOT NULL COMMENT 'Имя',
  `lastname` varchar(45) NOT NULL COMMENT 'Отчество',
  `adres` varchar(255) DEFAULT NULL,
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `persons_BEFORE_INSERT` BEFORE INSERT ON `persons` FOR EACH ROW BEGIN
	...
	if new.photo='' or new.photo is null then 
		 set new.photo='66d9d2d54bebdc4e16942412c97b622c.png';
	end if;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
CREATE TABLE `property` (
  `idProperty` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id Недвижимости',
  `type` int(11) NOT NULL COMMENT 'Тип недвижимости(Вторичная/Новострока) // 1-Вторичка, 0-Новостройка',
  ...
  `buyRent` tinyint(1) NOT NULL COMMENT 'Продажа/аренда',
  ...
  `isRemoveBuyRent` tinyint(1) NOT NULL,
  ...
  KEY `type` (`type`),
  CONSTRAINT `area` FOREIGN KEY (`idArea`) REFERENCES `areas` (`idArea`),
...
INSERT INTO `property` VALUES (1,1,1,1,NULL,2,1,1,1,1,1,1,NULL,NULL,'фыфввф ывфывфыв фыв фывфыв фыв ',0.00,1),(2,2,3,1,1,5,NULL,1,1,2,5,10,NULL,NULL,NULL,1000.00,1),(3,4,8,1,1,4,2,0,NULL,NULL,10,2,NULL,NULL,NULL,0.00,0),(4,5,4,NULL,1,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.00,1),(5,3,6,1,NULL,7,3,0,NULL,NULL,NULL,4,2,NULL,NULL,0.00,0),(6,6,7,NULL,1,NULL,NULL,1,NULL,NULL,1,NULL,1,NULL,NULL,0.00,0),(7,2,2,1,1,2,3,0,1,NULL,NULL,NULL,NULL,NULL,NULL,2000.00,0),(8,2,5,NULL,1,NULL,NULL,1,0,2,5,5,NULL,NULL,NULL,0.00,0),(9,1,10,1,NULL,10,5,1,0,1,3,3,NULL,NULL,NULL,0.00,0),(10,1,10,1,1,10,5,1,1,3,5,10,NULL,NULL,NULL,0.00,0),(11,1,4,1,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,10000.11,0);
...
--
-- Dumping events for database 'user_21'
--

--
-- Dumping routines for database 'user_21'
--
...
-- Dump completed on 2018-12-25 14:49:18
